...
class Drawer:
    ...
    def get_contours(self):
        #To find contours in an image and crop them and return a list with cropped contours
        ...
        main_image = cv2.GaussianBlur(src=main_image, ksize=(3, 3), sigmaX=1)
    ...
    def mouse_callback(self, event, x, y, flags, params):
        #method for drawing circles on an image
